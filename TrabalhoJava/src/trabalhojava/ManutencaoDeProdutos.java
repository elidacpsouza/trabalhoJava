 ...
 * @author Elida
 */
public class ManutencaoDeProdutos extends javax.swing.JDialog {

    /**
     * Creates new form ManutencaoDeProdutos
     */
    ...
    public ManutencaoDeProdutos(java.awt.Frame parent, boolean modal, boolean modoPedido) {
        setModal(true);
    ...
    private void btnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditActionPerformed
        ...
        if (linhasSelecionadas.length > 1) {
            JOptionPane.showMessageDialog(this, "Selecione somente um produto para editar!", "Erro", JOptionPane.ERROR_MESSAGE);
            ...
            Produto produto = modeloTabela.getProduto(linhasSelecionadas[0]);
            CadastroProduto cad = new CadastroProduto(this, true, false, produto);
            cad.setVisible(true);
            jtfFiltro.setText("");
            atualizaTabela();
        }
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        if (linhaClicada > -1) {
            try {
                ...
                for (Produto contato : listaExcluir) {
                    modeloTabela.removeProduto(contato);
                }
                jtfFiltro.setText("");
            } catch (Exception ex) {
            ...
            JOptionPane.showMessageDialog(this, "Selecione ao menos um produto para excluir.", "Erro", JOptionPane.ERROR_MESSAGE);
        }
    ...
    private void jTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTableMouseClicked
        ...
        jtfFiltro.setText(produto.getDescricao());
    }//GEN-LAST:event_jTableMouseClicked

    private void btnInsertActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInsertActionPerformed
        CadastroProduto cad = new CadastroProduto(this, true, true, null);
        cad.setVisible(true);
        jtfFiltro.setText("");
        atualizaTabela();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ManutencaoDeProdutos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ManutencaoDeProdutos dialog = new ManutencaoDeProdutos(new javax.swing.JFrame(), true, false);
    ...
    private void filtrarProdutos() {
        try {
            ProdutoDao dao = new ProdutoDao();
            List<Produto> lista = dao.getLista(jtfFiltro.getText());
            modeloTabela.setListaProdutos(lista);
            btnListar.setSelected(false);
        } catch (Exception ex) {
            ex.printStackTrace();
    ...
    private void iniciaTabela() {
        ...
        jTable.getColumn("DESCRIÇÃO").setMinWidth(100);
        jTable.addKeyListener(new KeyListener() {
            ...
            public void keyPressed(KeyEvent e) {
                if (e.getKeyCode() == KeyEvent.VK_ENTER && modoPedido) {
                    if (jTable.getSelectedRowCount() == 1 && linhaClicada > -1) {
                        produtoSelecionado = modeloTabela.getProduto(linhaClicada);
                        dispose();
                    }
